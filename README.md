<picture>
  ...
  <img src="./assets/banner-dark.svg?v=6" alt="Ashwini Tiwari — AI Systems Engineer" width="100%"/>
</picture>
...
<img src="./assets/status-card.svg?v=6" alt="System status card" width="320"/>
...
<img src="./assets/quido-pipeline.svg?v=6" alt="Quido agentic RAG pipeline" width="100%"/>
...
<img src="./assets/automate-pipeline.svg?v=6" alt="Workflow automation pipeline" width="100%"/>
...
<img src="./assets/pipeline-commitra.svg?v=6" alt="Commitra live pipeline status" width="100%"/>
...
<img src="./assets/aria-pipeline.svg?v=6" alt="ARIA reasoning pipeline" width="100%"/>
...
<img src="./assets/dashboard.svg?v=6" alt="Skills and stack" width="100%"/>

## `> milestones`

<img src="./assets/milestones.svg?v=6" alt="Milestones" width="100%"/>
